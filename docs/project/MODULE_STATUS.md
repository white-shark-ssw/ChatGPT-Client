...
| Build/runtime metadata | **b71 exact identity; Runtime pending** | Xcode settings / built `Info.plist` | `0.1.0 (71)`, source `af8d4a4b291c...`, Artifact `9756491305`; b39-b71 reserved. |
...
| IPA build / CI packaging | **Stable capability; b71 Artifact valid** | `scripts/build_ipa.sh`, workflow | Push `33388396118/99476130099`, PR `33388399484/99476140778`, Artifact `9756491305`, IPA `a9322dba...fd65`; package b71/source `af8d4a4b291c`/iOS14/arm64. |
...
| Streaming / Send | **Active — b67 transport accepted; b71 presentation Runtime gate** | `DEV-send-stream`; PR #29; TD-029 | b71 exact source/Push+PR CI/Artifact/package verified; presentation/performance Runtime pending. |
| User-visible reasoning | **b71 Code/CI/Artifact/package verified; Runtime pending** | `ConversationRepository` + `DEV-send-stream` | Ordered timeline retained; exact service duration may label compact summary; detail moves to a presentation-only sheet so historical disclosure no longer rebuilds all b38 row geometry. |
| Tool activity presentation | **b71 Code/CI/Artifact/package verified; Runtime pending** | `DEV-send-stream` | Meaningful compact tool rows + bounded local icons in conversation; intrinsic input/output detail moves to one outer-scroll reasoning sheet; exact-parent/GitHub authorization unchanged. |
| Expandable GitHub tool detail | **b65 mapping accepted; b71 sheet presentation Runtime pending** | `DEV-send-stream` | Authorized exact-parent GitHub input/output remains unchanged; b71 removes the 260pt nested-scrolling cap from the new presentation-only sheet and keeps disclosure state local to that sheet. |
...
- b70 remains a valid reserved package but its exact iPhone/iOS17 presentation Runtime is rejected. b71 source `af8d4a4b291c05fb63a50cee0261c06d7ce474d3`, Artifact `9756491305`, IPA `a9322dba...fd65` is the current presentation/performance Runtime candidate; package identity independently verified.
...
- b39-b71 are reserved. Phase 9 Stable/Frozen: No.
