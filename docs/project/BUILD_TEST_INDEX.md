...
| `DEV-native-read-path-0.1.0-b9` | `DEV-native-read-path` | `0.1.0 (9)` | `dev/native-read-path-20260826` / PR #9 | **`d9c9b4da8bdecd2d6c097d4db2f3789300fc99c7`** | **Code written + CI passed + Artifact produced + Runtime/manual/real-device tested** | **Run `32978476582`; artifact ID `9610449216`; IPA `ChatGPTClient-0.1.0-b9-dev-native-read-path.ipa`; IPA SHA-256 `16168a9db6f03e4ab00ddae4149451563a31fe2862cfb7ab18320329d186b99e`; ZIP digest `sha256:0851787dacd882e86f398adebd4680493b6693d08865521fb677d7d9ecf3892f`** | Exact export: Release/iPhone/iOS 17.0/source `d9c9b4da8bde`. After explicit login, list HTTP 200 28/29. Position 1/hash `e95144bf259d`: HTTP 200, 1,529,866 bytes, mapping 337, visible 154, 5,668.41 ms. Position 13/hash `084c1f4870f3`: HTTP 200, 7,503,328 bytes, mapping 2023, visible 843, 20,742.89 ms. User confirmed both fully readable. | **Runtime-accepted native-read candidate; PR #9 merge pending at this revision** |
...
- This is sufficient runtime evidence for the core `DEV-native-read-path` acceptance criteria on tested iPhone/iOS 17.0 scope.
