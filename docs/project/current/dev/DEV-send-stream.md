...
- Current checkpoint docs head: `1cb5dc709f97b1e4e791ff9badfafd593c6f6276`
...
- pending: PR #29 title/body should be synced to this 2×2 gate;
- next exact action regardless of metadata sync: user runs Control A in visible Web Rule Lab; no product source/version/Candidate/Artifact changes;
