...
When complete, update durable project docs, record final validation/candidate identity in `BUILD_TEST_INDEX.md`, remove only that task's current checkpoint, leave all other Active checkpoints untouched, and keep historical evidence in Git/PR/index.
