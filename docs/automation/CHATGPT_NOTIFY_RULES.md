...
- 不固定添加 `ChatGPT · ChatGPT-Client` 前缀。
...
- 尽量保留自然换行，使展开通知后能看到更多实际回答内容，而不是只发一句“任务完成”。
...
```text
[BARK_NOTIFY_V1]
{"project":"ChatGPT-Client","title":"<当前会话标题或自然生成的任务标题>","body":"<最终回答开头的正文预览，建议 150–500 字符>","url":"https://chatgpt.com/"}
```
